...
// Same token registry as documentAmoyValidWithToken but a different merkle root
// that has NOT been minted — verify() should return DOCUMENT_NOT_MINTED.
export const documentAmoyNotIssuedTokenRegistry: WrappedDocument<CustomDocument> = {
  version: SchemaId.v2,
  data: {
    $template: {
  ...
  signature: {
    ...
    // Different hash from documentAmoyValidWithToken — this token has NOT been minted
    targetHash: "3bb24eb7783756148fb2c13ccb12c0a074661599344ed16f6e01c34ea867d9e3",
    proof: [],
    merkleRoot: "3bb24eb7783756148fb2c13ccb12c0a074661599344ed16f6e01c34ea867d9e3",
  },
};
